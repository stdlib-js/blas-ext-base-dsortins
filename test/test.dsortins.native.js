...
var dsortins = tryRequire( resolve( __dirname, './../lib/dsortins.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( dsortins.length, 4, 'has expected arity' );
	t.end();
});
