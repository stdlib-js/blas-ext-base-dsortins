...
```javascript
import dsortins from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsortins@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dsortins/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dsortins/actions/workflows/test.yml?query=branch:v0.2.0
